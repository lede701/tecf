...
package net.mcreator.tecf.block;
...
import net.mcreator.tecf.gui.SuperFurnaceGui;
...
public class SuperFurnaceBlockBlock extends Tecf15ModElements.ModElement {
	@ObjectHolder("tecf15:super_furnace_block")
	public static final Block block = null;
	@ObjectHolder("tecf15:super_furnace_block")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public SuperFurnaceBlockBlock(Tecf15ModElements instance) {
		super(instance, 6);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("super_furnace_block"));
	}
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("super_furnace_block");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Super Furnace");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new SuperFurnaceGui.GuiContainerMod(id, inventory,
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("super_furnace_block");
		}
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new SuperFurnaceGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}
